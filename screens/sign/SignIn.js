    ...
    signInAsync = async (request) => {
      ...
      submitData = (email, password) => {
        ...
        if(email != undefined && password != undefined) {
          ...
          axios.post('https://codelinepds.herokuapp.com/login/seller', request, {
            headers : {
            ...
            this.setState({responseStatus : JSON.stringify(err.message)})
      ...
      return(
        <View style={[Styles.container, {height : 'auto'}]}>
          <KeyboardAvoidingView behavior="padding" style={{height : 'auto'}}>
              <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={[Styles.noHeaderMarginTop, {height : 'auto', paddingBottom : 20}]}>
                  <View>
